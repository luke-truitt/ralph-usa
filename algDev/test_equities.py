...
print('Mean Tests')
print(Finance.mean(testEquity1))
print(Finance.mean(testEquity2))

print('Variance Tests')
print(Finance.variance(testEquity1))
print(Finance.variance(testEquity2))

print('Covariance Tests')
print(Finance.covariance(testEquity1,testEquity1))
print(Finance.covariance(testEquity1,testEquity2))

print('Correlation Tests')
print(Finance.correlation(testEquity1, testEquity2))
